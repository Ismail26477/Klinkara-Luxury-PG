...
const botResponses: { [key: string]: string } = {
  ...
  'price': 'Our pricing ranges from ₹6,500 to ₹18,000 per month depending on occupancy. This includes all meals, WiFi, housekeeping, and access to all amenities. Would you like to know more about any specific room type?',
  ...
  'amenities': 'Klinkara offers premium amenities including: High-speed WiFi, 24/7 security, gym, common area with TV, laundry service, modern kitchen, RO water, power backup, and covered parking.',
  'visit': 'I\'d be happy to help you schedule a visit! You can fill out the booking form on our website, or call us at +91 98765 43210. Our visiting hours are Mon-Sat 9 AM - 7 PM and Sunday 10 AM - 5 PM.',
  'location': 'We\'re located at 123 MG Road, Koramangala, Bangalore - 560034. It\'s just 0.5 km from Koramangala Metro Station. We also offer free pickup from the metro for site visits!',
  'default': 'Thank you for your interest in Klinkara Luxury PG! I can help you with information about our rooms, prices, amenities, food, and visit scheduling. What would you like to know?',
};
...
const AIAssistant = () => {
  ...
  const getBotResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes('visit') || lowerMessage.includes('tour') || lowerMessage.includes('schedule') || lowerMessage.includes('book')) {
